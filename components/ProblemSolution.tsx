		...
		<section id="problem" className="py-24 relative">
			<div className="max-w-7xl mx-auto px-6">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
					{/* Problem Card */}
					<div className="p-8 md:p-10 rounded-3xl bg-card border border-border hover:border-red-500/30 transition-colors group relative overflow-hidden">
					...
					{/* Solution Card */}
					<div className="p-8 md:p-10 rounded-3xl bg-card border border-border hover:border-green-500/30 transition-colors group relative overflow-hidden">
